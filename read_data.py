...
def load_training_data(vocal_name):
    ...
    return spectral_data, aperiodic_data, label_data, cutoff_points
...
def read_training_data(vocal_name='', load=False):
    ...
    if not load:
        ...
        data = [spectral_data, aperiodic_data, label_data, cutoff_points]

        spectral_data, aperiodic_data, label_data, column_list = process_and_save(data, vocal_name)
    else:
        spectral_data, aperiodic_data, label_data, cutoff_points = load_training_data(vocal_name)

    return spectral_data, aperiodic_data, label_data, cutoff_points


def read_test_data(trained_vocal_name, compare=False):
    ...
    spectral_data, aperiodic_data, label_data, column_list = process_and_save(data, trained_vocal_name, save=False)
